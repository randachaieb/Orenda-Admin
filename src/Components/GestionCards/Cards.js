...
class Cards extends React.Component {
  ...
  showModalEdit = (event) => {
    axios
      .get("http://localhost:5000/api/v1/card/" + event)
      .then((response) => {
        this.setState({
          id: event,
  ...
  handleOkDelete = (event) => {
    axios
      .delete("http://localhost:5000/api/v1/card/delete/", {
        data: { id: event },
        headers: {
  ...
  render() {
    return (
      <>
        ...
        >
          <Input placeholder="Title" value={this.state.name} />
          <br />
          <br />
              ...
              <Col className="gutter-row" span={6} key={index}>
                <Card
                  ...
                  actions={[
                    <EditOutlined
                      key="edit"
                      onClick={(e) => this.showModalEdit(card._id)}
                    />,
                    <DeleteOutlined
                      key="delete"
                      onClick={(e) => this.showModalDelete(card._id)}
                    />,
                  ]}
                >
                  <Meta
